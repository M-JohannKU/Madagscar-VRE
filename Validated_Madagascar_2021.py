...
filename = r"C:\Users\Asus\Desktop\Thesis\ERA5\Madagascar_5_years_componants\MAD_2021_5year_componant.nc"
...
fig.suptitle('Daily ERA5 wind and solar capacity factors 2021', fontsize=16)
...
plt.title('Monthly ERA5 solar and wind capacity factors 2021')
plt.grid(True)
plt.legend()
...
plt.title('Monthly ERA5 stabilty factors 2021')
...
np.save('CF_wind_2021.npy', Wind_CF)
np.save('CSTAB_2021.npy', Cstab)
np.save('Wind_CF_2021.npy',Wind_CF)
np.save('Solar_CF_2021.npy',Solar_CF)
np.save('yerr_2021',yerr)