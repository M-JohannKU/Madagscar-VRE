...
#fig.suptitle('ERA5 wind and solar daily capacity factors 2018', fontsize=16)
...
np.save('CF_wind_2018.npy', Wind_CF)
np.save('CSTAB_2018.npy', Cstab)
np.save('Wind_CF_2018.npy',Wind_CF)
np.save('Solar_CF_2018.npy',Solar_CF)
np.save('yerr_2018.npy',yerr)