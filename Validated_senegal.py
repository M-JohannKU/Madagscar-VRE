...
filename = r"C:\Users\Asus\Desktop\Thesis\ERA5\2008\Senegal_2017.nc"
...
Africa_Shape = gpd.read_file(r"C:\Users\Asus\Desktop\Thesis\Shapefiles\Senegal\Senegal.shx", crs="epsg:4326")
...
line_colors = ['blue', 'green', 'red', 'purple', 'orange', 'brown', 'pink', 'gray', 'cyan', 'magenta', 'blue', 'green']
...
#saving figure 
plt.savefig('Taiba Ndaiye fill_between', dpi=300, bbox_inches='tight')
...
plt.plot(months, Solar_CF,'yellow', label='Solar', marker='o', linestyle='-')
plt.plot(months, Wind_CF,'blue', label='Wind', marker='o', linestyle='-')

plt.xlabel('Months')
plt.ylabel('Capacity Factor')
plt.title('Monthly Solar and Wind Capacity Factors')
plt.grid(True)
plt.legend()
...
plt.title('Monthly Stabilty Factors')
...
# plt.scatter(Wind_CF, Cstab, label='Cstab', marker='o')
