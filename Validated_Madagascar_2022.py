...
filename = r"C:\Users\Asus\Desktop\Thesis\ERA5\Madagascar_5_years_componants\MAD_2022_5year_componant.nc"
...
fig.suptitle('Daily ERA5 wind and solar capacity factors 2022', fontsize=16)
...
plt.title('Monthly ERA5 solar and wind capacity factors 2022')
plt.grid(True)
plt.legend()
...
plt.title('Monthly ERA5 stabilty factors 2022')
...
np.save('CF_wind_2022.npy', Wind_CF)
np.save('CSTAB_202.npy', Cstab)
np.save('Wind_CF_2022.npy',Wind_CF)
np.save('Solar_CF_2022.npy',Solar_CF)
np.save('yerr_2022',yerr)